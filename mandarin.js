var Mandarin = function (name) {
		...
		this.startAnim = function () {
			...
			document.styleSheets[0].insertRule( "." + this.animationName  +"_class {"+browserPrefix+"animation:"+str1+"; "+browserPrefix+"animation-delay:"+str2+"; "+browserPrefix+"animation-fill-mode:forwards}" ,0);
